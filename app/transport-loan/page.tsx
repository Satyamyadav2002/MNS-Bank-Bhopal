...
import { ArrowRight, CheckCircle2, Truck, Zap, Shield } from "lucide-react"
    ...
    <BankingSegmentProvider>
      <div className="min-h-screen font-sans">
        ...
        <PageShell
          ...
          subtitle="Finance your commercial vehicles — trucks, tempos, buses, and three-wheelers — at competitive rates with quick approvals."
          breadcrumbs={[{ label: "Business" }, { label: "Loans" }, { label: "Transport Loan" }]}
          ctaLabel="Apply Now"
          ctaHref="/contact-us"
        >
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
            {[
              { label: "Rate From",     value: "11.00% p.a." },
              { label: "Loan Amount",   value: "Up to ₹75L" },
              { label: "Tenure",        value: "Up to 7 Yrs" },
              { label: "Down Payment",  value: "Min. 15%" },
            ].map((s, i) => (
          ...
          <div className="grid lg:grid-cols-3 gap-5 mb-10">
            {[
              { icon: Truck,  title: "New & Used Vehicles",     desc: "Finance both new and used commercial vehicles — trucks, tempos, autos, and buses." },
              { icon: Zap,    title: "Quick Approval in 5 Days", desc: "Hassle-free processing with minimal paperwork and a dedicated loan officer." },
              { icon: Shield, title: "Flexible Repayment",      desc: "EMI schedules aligned with your route income and seasonal business cycles." },
            ].map((f, i) => (
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                "Individual / partnership / proprietorship / company",
                "Valid driving licence (for individual applicants)",
                "Vehicle quotation / RC book (for used vehicles)",
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/contact-us" className="inline-flex items-center gap-2 bg-[#C0001B] text-white font-bold px-8 py-3.5 rounded-xl hover:bg-[#8B0015] transition-colors shadow-[0_4px_12px_rgba(192,0,27,0.2)]">
              Apply for Transport Loan <ArrowRight className="w-4 h-4" />
            </Link>
