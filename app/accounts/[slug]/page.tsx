      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-[80px]">
          <div className="bg-gradient-to-br from-[#C0001B] via-[#111827] to-[#C0001B] py-20 lg:py-28 px-4 relative">
            ...
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-[#C0001B]/[0.08] to-transparent rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  ...
                  <Link href="/auth/register" className="bg-transparent hover:bg-white/5 text-white border border-white/20 hover:border-white/40 px-8 h-14 rounded-full font-bold transition-all duration-300 w-full sm:w-auto flex items-center justify-center gap-2 backdrop-blur-sm">
                    <ShieldCheck className="w-5 h-5 text-[#C0001B]"/> Verify KYC Online
                  </Link>
                </div>
              </div>
              ...
              <div className="w-full lg:w-[380px] shrink-0">
                <div className="bg-white/10 backdrop-blur-[32px] rounded-[32px] p-8 border border-white/10 shadow-[0_32px_64px_rgba(0,0,0,0.25)] relative overflow-hidden group hover:border-[#C0001B]/30 transition-all duration-500">
                  ...
                  <p className="text-[15px] font-bold uppercase tracking-[0.1em] text-[#C0001B] mb-8">
                    {data.statLabel}
                  </p>
        ...
        <section className="max-w-7xl mx-auto px-4 py-20">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 min-h-[400px]">
              ...
              {activeTab === 'overview' && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <div className="inline-flex items-center gap-2 mb-4">
                    ...
                    <span className="text-[12px] font-bold uppercase tracking-[0.14em] text-[#C0001B]">About This Account</span>
                  </div>
              ...
              {activeTab === 'features' && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                  ...
                  <h2 className="font-serif text-[32px] lg:text-[40px] font-bold text-[#111827] mb-8 leading-tight">Features & Facilities</h2>
                    ...
                    {data.features.map((feature: string, idx: number) => (
                      <div key={idx} className="bg-white p-6 rounded-[20px] border border-[#e5e7eb]/80 hover:border-[#C0001B]/30 flex gap-4 group">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F5ECE8] to-[#FAF7F2] border border-[#e5e7eb] flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                            <Star className="w-4.5 h-4.5 text-[#C0001B]" />
                        </div>
              ...
              {activeTab === 'eligibility' && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                  ...
                  <h2 className="font-serif text-[32px] lg:text-[40px] font-bold text-[#111827] mb-8 leading-tight">Who can open this account?</h2>
                  ...
                  <div className="bg-white rounded-[24px] p-8 lg:p-10 border border-[#e5e7eb]/80">
                    ...
                    <div className="p-5 lg:p-6 bg-gradient-to-br from-[#FAF7F2] to-[#F5ECE8] rounded-[20px] border border-[#e5e7eb] border-l-4 border-l-[#C0001B] text-[14px] text-[#6B7280] leading-relaxed">
                        <strong className="text-[#111827]">Regulatory Note:</strong> Standard KYC documents (Aadhaar, PAN Card, two passport size photographs) are mandatory as per RBI guidelines to open any account.
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'apply' && (
                <div id="apply-section" className="animate-in fade-in slide-in-from-bottom-4 duration-700 pt-8 mt-[-32px]">
                  ...
                  <h2 className="font-serif text-[32px] lg:text-[40px] font-bold text-[#111827] mb-3 leading-tight">Account Opening Request</h2>
                  ...
                  <form className="bg-white rounded-[32px] p-8 lg:p-10 border border-[#e5e7eb] shadow-[0_24px_48px_rgba(0,0,0,0.03)] relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 relative z-10">
                      <div className="space-y-2">
                        <label className="text-[13px] font-bold text-[#111827] uppercase tracking-[0.05em]">Full Name / Entity Name</label>
                        <input type="text" className="w-full bg-gray-50 border border-[#e5e7eb] rounded-xl h-14 px-5 focus:ring-2 focus:ring-[#C0001B]/50 focus:border-[#C0001B] outline-none transition-all font-medium text-[#111827]" placeholder="e.g. John Doe" />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2 md:col-span-2">
                        <label className="text-[13px] font-bold text-[#111827] uppercase tracking-[0.05em]">Preferred Branch</label>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-[24px] p-7 border border-[#e5e7eb]/80 sticky top-[180px]">
                <h3 className="font-serif text-[22px] font-bold text-[#111827] mb-6 flex items-center gap-2">
                  <Landmark className="w-5 h-5 text-[#C0001B]" /> Quick Links
                </h3>
                <div className="space-y-3">
                  <Link href="/service-charges" className="flex flex-col p-4 rounded-xl bg-gradient-to-br from-[#FAF7F2] to-white border border-[#e5e7eb] hover:border-[#C0001B]/30 transition-all duration-300 group hover:shadow-md">
                  ...
                  <Link href="/download-forms" className="flex flex-col p-4 rounded-xl bg-gradient-to-br from-[#FAF7F2] to-white border border-[#e5e7eb] hover:border-[#C0001B]/30 transition-all duration-300 group hover:shadow-md">
                    <div className="flex items-center gap-3 text-[#111827] font-bold text-[15px] mb-1">
                      <div className="w-9 h-9 rounded-full bg-white shadow-sm flex items-center justify-center text-[#C0001B] group-hover:bg-[#C0001B] group-hover:text-white transition-colors duration-400">
